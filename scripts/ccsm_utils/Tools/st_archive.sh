...
do
    ...
    set gcam2glm_restart.r.*.nc        ;  latest=`ls -rt $* 2> /dev/null | tail -1`; cp $latest ${sta}/rest/${dname} 2> /dev/null; dispose ifiles_y ${sta}/lnd/hist $*
    set iac_restart.r.*.nc             ;  latest=`ls -rt $* 2> /dev/null | tail -1`; cp $latest ${sta}/rest/${dname} 2> /dev/null; dispose ifiles_y ${sta}/lnd/hist $*
    set gcam_restart*.xml              ;  latest=`ls -rt $* 2> /dev/null | tail -1`; cp $latest ${sta}/rest/${dname} 2> /dev/null; dispose ifiles_y ${sta}/lnd/hist $*
    set iac_clmC_file.r.*.nc           ;  latest=`ls -rt $* 2> /dev/null | tail -1`; cp $latest ${sta}/rest/${dname} 2> /dev/null; dispose ifiles_y ${sta}/lnd/hist $*
    set surfdata_iESM_dyn.nc           ;  latest=`ls -rt $* 2> /dev/null | tail -1`; cp $latest ${sta}/rest/${dname} 2> /dev/null; dispose ifiles_y ${sta}/lnd/hist $*
    set co2flux_iESM_dyn.nc            ;  latest=`ls -rt $* 2> /dev/null | tail -1`; cp $latest ${sta}/rest/${dname} 2> /dev/null; dispose ifiles_y ${sta}/lnd/hist $*
    set iESM_Dyn_CropPast.nc           ;  latest=`ls -rt $* 2> /dev/null | tail -1`; cp $latest ${sta}/rest/${dname} 2> /dev/null; dispose ifiles_y ${sta}/lnd/hist $*
    set surfdata_360x720_mcrop_dyn.nc  ;  latest=`ls -rt $* 2> /dev/null | tail -1`; cp $latest ${sta}/rest/${dname} 2> /dev/null; dispose ifiles_y ${sta}/lnd/hist $*
    set restart_glm.ini                ;  latest=`ls -rt $* 2> /dev/null | tail -1`; cp $latest ${sta}/rest/${dname} 2> /dev/null; dispose ifiles_y ${sta}/lnd/hist $*
    set test_chdata.glm.restart*.nc    ;  latest=`ls -rt $* 2> /dev/null | tail -1`; cp $latest ${sta}/rest/${dname} 2> /dev/null; dispose ifiles_y ${sta}/lnd/hist $*
    set ${CASE}.iac.h*                 ;                                                                                           dispose ifiles_n ${sta}/lnd/hist $*
    set database.dbxml                 ;                                                                                           dispose ifiles_n ${sta}/lnd/hist/${dname} $*
    set *db.*                          ;                                                                                           dispose ifiles_n ${sta}/lnd/hist/${dname} $*
    set iac_clmC_file.h*.nc            ;                                                                                           dispose ifiles_n ${sta}/lnd/hist $*
    set surfdata_iESM.*.nc             ;                                                                                           dispose ifiles_n ${sta}/lnd/hist $*
    set test_chdata.glm.state.*.nc     ;                                                                                           dispose ifiles_n ${sta}/lnd/hist $*
    set test.glm.lu.*.nc               ;                                                                                           dispose ifiles_n ${sta}/lnd/hist $*
    set gcrop*.txt                     ;                                                                                           dispose ifiles_n ${sta}/lnd/hist $*
    set gpast*.txt                     ;                                                                                           dispose ifiles_n ${sta}/lnd/hist $*
    set gothr*.txt                     ;                                                                                           dispose ifiles_n ${sta}/lnd/hist $*
