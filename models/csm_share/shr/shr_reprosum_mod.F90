...
!-----------------------------------------------------------------------
   public :: &
      shr_reprosum_getDefaultOpts, &! get default runtime options
...
!-----------------------------------------------------------------------
   ...
   logical, public     :: shr_reprosum_recompute = def_repro_sum_recompute

   real(r8), parameter :: def_rel_diff_max = -1.0_r8
   real(r8), public    :: shr_reprosum_reldiffmax = def_rel_diff_max
...
!========================================================================
!
   subroutine shr_reprosum_getDefaultOpts(repro_sum_use_ddpdd_out,    &
...
!-----------------------------------------------------------------------
   ...
   end subroutine shr_reprosum_getDefaultOpts
!
!========================================================================
!
...
!
   ...
   subroutine shr_reprosum_calc (arr, arr_gsum, nsummands, dsummands, nflds, &
                         ddpdd_sum,                                  &
