...
!-------------------------------------------------------
      ...
      rate(:,:,250) = 2.10e-6_r8
      rate(:,:,260) = 1.70e-10_r8
      rate(:,:,261) = 1.20e-10_r8
      rate(:,:,262) = 1.50e-10_r8
      rate(:,:,263) = 7.20e-11_r8
      rate(:,:,264) = 2.84e-10_r8
      rate(:,:,265) = 1.80e-10_r8
      rate(:,:,266) = 9.60e-11_r8
      rate(:,:,267) = 4.10e-11_r8
      rate(:,:,288) = 1.70e-13_r8
      ...
      rate(:,:,255) = 9.60e-12_r8 * exp( -234._r8 * itemp(:,:) )
      rate(:,:,257) = 1.90e-13_r8 * exp( 520._r8 * itemp(:,:) )
      rate(:,:,258) = 1.70e-12_r8 * exp( -710._r8 * itemp(:,:) )
      rate(:,:,268) = 2.30e-11_r8 * exp( -200._r8 * itemp(:,:) )
      rate(:,:,269) = 3.05e-11_r8 * exp( -2270._r8 * itemp(:,:) )
      rate(:,:,270) = 1.10e-11_r8 * exp( -980._r8 * itemp(:,:) )
      rate(:,:,272) = 4.10e-11_r8 * exp( -450._r8 * itemp(:,:) )
      rate(:,:,273) = 8.10e-11_r8 * exp( -30._r8 * itemp(:,:) )
      rate(:,:,274) = 7.30e-12_r8 * exp( -1280._r8 * itemp(:,:) )
      rate(:,:,275) = 2.80e-11_r8 * exp( 85._r8 * itemp(:,:) )
      exp_fac(:,:) = exp( 230._r8 * itemp(:,:) )
      rate(:,:,277) = 6.00e-13_r8 * exp_fac(:,:)
      rate(:,:,297) = 1.90e-11_r8 * exp_fac(:,:)
      rate(:,:,305) = 1.50e-12_r8 * exp_fac(:,:)
      exp_fac(:,:) = exp( 290._r8 * itemp(:,:) )
      rate(:,:,279) = 6.40e-12_r8 * exp_fac(:,:)
      rate(:,:,304) = 4.10e-13_r8 * exp_fac(:,:)
      rate(:,:,282) = 1.00e-12_r8 * exp( -1590._r8 * itemp(:,:) )
      rate(:,:,283) = 3.50e-13_r8 * exp( -1370._r8 * itemp(:,:) )
      rate(:,:,286) = 2.60e-12_r8 * exp( -350._r8 * itemp(:,:) )
      rate(:,:,287) = 1.00e-11_r8 * exp( -3300._r8 * itemp(:,:) )
      rate(:,:,289) = 2.50e-12_r8 * exp( -130._r8 * itemp(:,:) )
      rate(:,:,290) = 3.00e-12_r8 * exp( -500._r8 * itemp(:,:) )
      exp_fac(:,:) = exp( -800._r8 * itemp(:,:) )
      rate(:,:,291) = 2.90e-12_r8 * exp_fac(:,:)
      rate(:,:,294) = 1.70e-11_r8 * exp_fac(:,:)
      rate(:,:,296) = 1.70e-11_r8 * exp_fac(:,:)
      rate(:,:,292) = 1.20e-12_r8 * exp( -330._r8 * itemp(:,:) )
      rate(:,:,293) = 6.50e-12_r8 * exp( 135._r8 * itemp(:,:) )
      rate(:,:,295) = 4.80e-12_r8 * exp( -310._r8 * itemp(:,:) )
      rate(:,:,299) = 4.50e-12_r8 * exp( 460._r8 * itemp(:,:) )
      exp_fac(:,:) = exp( 260._r8 * itemp(:,:) )
      rate(:,:,300) = 8.80e-12_r8 * exp_fac(:,:)
      rate(:,:,303) = 2.30e-12_r8 * exp_fac(:,:)
      rate(:,:,302) = 9.50e-13_r8 * exp( 550._r8 * itemp(:,:) )
      rate(:,:,308) = 1.20e-10_r8 * exp( -430._r8 * itemp(:,:) )
      rate(:,:,309) = 1.90e-11_r8 * exp( 215._r8 * itemp(:,:) )
      rate(:,:,310) = 2.17e-11_r8 * exp( -1130._r8 * itemp(:,:) )
      rate(:,:,311) = 2.40e-12_r8 * exp( -1250._r8 * itemp(:,:) )
      rate(:,:,312) = 1.64e-12_r8 * exp( -1520._r8 * itemp(:,:) )
      rate(:,:,314) = 2.35e-12_r8 * exp( -1300._r8 * itemp(:,:) )
      ...
      call jpl( rate(1,1,301), m, 0.6_r8, ko, kinf, n )
