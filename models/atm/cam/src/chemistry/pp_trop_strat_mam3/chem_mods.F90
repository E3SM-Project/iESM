...
!--------------------------------------------------------------
      ...
      integer, parameter :: phtcnt = 70, & ! number of photolysis reactions
                            rxntot = 331, & ! number of total reactions
                            gascnt = 261, & ! number of gas phase reactions
                            nabscol = 2, & ! number of absorbing column densities
                            gas_pcnst = 136, & ! number of "gas phase" species
                            ...
                            clscnt4 = 117, & ! number of species in implicit class
