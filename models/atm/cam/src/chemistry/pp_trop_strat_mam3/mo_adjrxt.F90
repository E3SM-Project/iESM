...
!--------------------------------------------------------------------
      ...
      do k = 1,pver
         ...
         rate(:,k,280) = rate(:,k,280) * inv(:,k, 1)
         rate(:,k,284) = rate(:,k,284) * inv(:,k, 1)
         rate(:,k,285) = rate(:,k,285) * inv(:,k, 1)
         rate(:,k,301) = rate(:,k,301) * inv(:,k, 1)
         ...
         rate(:,k,260) = rate(:,k,260) * m(:,k)
         rate(:,k,261) = rate(:,k,261) * m(:,k)
         ...
         rate(:,k,318) = rate(:,k,318) * m(:,k)
         rate(:,k,319) = rate(:,k,319) * m(:,k)
         rate(:,k,320) = rate(:,k,320) * m(:,k)
         rate(:,k,323) = rate(:,k,323) * m(:,k)
         rate(:,k,324) = rate(:,k,324) * m(:,k)
         rate(:,k,329) = rate(:,k,329) * m(:,k)
         rate(:,k,330) = rate(:,k,330) * m(:,k)
