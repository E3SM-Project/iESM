...
!--------------------------------------------------------------
      ...
      rxt_tag_lst(:rxt_tag_cnt) = (/ 'jo2_a           ', 'jo2_b           ', 'jo3_a           ', 'jo3_b           ', &
                                     ...
                                     'jeuv_25         ', 'usr_O_O2        ', 'cph_O_O3        ', 'usr_O_O         ', &
                                     'cph_O2_1S_O     ', 'cph_O2_1S_O2    ', 'cph_O2_1S_N2    ', 'cph_O2_1S_O3    ', &
                                     'ag2             ', 'cph_O2_1D_O     ', 'cph_O2_1D_O2    ', 'cph_O2_1D_N2    ', &
                                     'ag1             ', 'cph_O1D_N2      ', 'cph_O1D_O2      ', 'cph_O1D_O2b     ', &
                                     'cph_N2D_O2      ', 'cph_N2D_O       ', 'cph_N_O2        ', 'cph_N_NO        ', &
                                     'cph_NO_HO2      ', 'cph_NO_O3       ', 'cph_NO2_O       ', 'tag_NO2_NO3     ', &
                                     'usr_N2O5_M      ', 'usr_HNO3_OH     ', 'tag_NO2_HO2     ', 'usr_HO2NO2_M    ', &
                                     'usr_CO_OH_b     ', 'cph_H_O2        ', 'cph_H_O3        ', 'cph_H_HO2       ', &
                                     'cph_OH_O        ', 'cph_OH_O3       ', 'cph_OH_HO2      ', 'cph_HO2_O       ', &
                                     'cph_HO2_O3      ', 'usr_HO2_HO2     ', 'tag_CLO_CLO     ', 'usr_CL2O2_M     ', &
                                     'het1            ', 'het2            ', 'het3            ', 'het4            ', &
                                     'het5            ', 'het6            ', 'het7            ', 'het8            ', &
