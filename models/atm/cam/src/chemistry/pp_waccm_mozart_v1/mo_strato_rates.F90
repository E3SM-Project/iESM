...
!-----------------------------------------------------------------------
      ...
      real(r8) :: &
        ...
        rad_nat_sulf                            ! temporary variable for sulfate radius (cm)
...
!-----------------------------------------------------------------------
               if( hclvmr > 0._r8 .and. clono2vmr > 0._r8 ) then
...
!-----------------------------------------------------------------------
               if( hclvmr > 0._r8 .and. hoclvmr > 0._r8 ) then
!-----------------------------------------------------------------------
!     	... Radius sulfate set (from sad module)
!           Set min radius to 0.001 microns (1e-7 cm)
!           Typical radius is 0.1 microns (1e-5 cm)
...
!-----------------------------------------------------------------------
               if( hclvmr > 0._r8 .and. hobrvmr > 0._r8 ) then
!-----------------------------------------------------------------------
!   	... Radius sulfate set (from sad module)
!           Set min radius to 0.001 microns (1e-7 cm)
!           Typical radius is 0.1 microns (1e-5 cm)
...
has_rad_nat_sulf : &
	    if( rad_nat_sulf > 0._r8 ) then
	       wrk = .25_r8*rad_nat_sulf
!-----------------------------------------------------------------------
...
!-----------------------------------------------------------------------
                  if( hoclvmr > 0._r8 .and. hclvmr > 0._r8 ) then
!-----------------------------------------------------------------------
!       ... gprob based on JPL06-2 for ICE.
!           also see Hanson and Ravi, JPC, 96, 2682-2691, 1992.
...
!-----------------------------------------------------------------------
                  if( hobrvmr > 0._r8 .and. hclvmr > 0._r8 ) then
!-----------------------------------------------------------------------
!       ... gprob based on JPL06-2 for ICE.
