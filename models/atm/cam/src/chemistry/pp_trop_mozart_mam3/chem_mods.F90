...
!--------------------------------------------------------------
      ...
      integer, parameter :: phtcnt = 40, & ! number of photolysis reactions
                            rxntot = 210, & ! number of total reactions
                            gascnt = 170, & ! number of gas phase reactions
                            nabscol = 2, & ! number of absorbing column densities
                            gas_pcnst = 107, & ! number of "gas phase" species
                            nfs = 4, & ! number of "fixed" species
                            relcnt = 0, & ! number of relationship species
                            grpcnt = 0, & ! number of group members
                            nzcnt = 828, & ! number of non-zero matrix entries
