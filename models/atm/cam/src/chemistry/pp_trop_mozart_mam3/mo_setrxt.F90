...
!-------------------------------------------------------
      ...
      rate(:,:,204) = 9.6e-12_r8 * exp( -234._r8 * itemp(:,:) )
      rate(:,:,206) = 1.9e-13_r8 * exp( 520._r8 * itemp(:,:) )
      rate(:,:,207) = 1.7e-12_r8 * exp( -710._r8 * itemp(:,:) )
      rate(:,:,210) = 7.8e-13_r8 * exp( -1050._r8 * itemp(:,:) )
      ...
      call jpl( rate(1,1,209), m, 0.8_r8, ko, kinf, n )
