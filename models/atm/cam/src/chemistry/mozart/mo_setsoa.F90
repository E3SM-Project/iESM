...
!
  ...
  subroutine soa_inti_equil(pbuf2d)
    ...
    rxn_soa(3) = get_rxt_ndx( 'soa3' )
    rxn_soa(4) = get_rxt_ndx( 'soa4' )
    rxn_soa(5) = get_rxt_ndx( 'soa5' )
    rxn_soa(6) = get_rxt_ndx( 'ox_p12' )
    rxn_soa(7) = get_rxt_ndx( 'soa7' )
    rxn_soa(8) = get_rxt_ndx( 'soa8' )
    rxn_soa(9) = get_rxt_ndx( 'soa9' )
    rxn_soa(10) = get_rxt_ndx( 'soa10' )
    if( all( rxn_soa(:) < 1 ) ) then
       has_soa = .false.
       return
    else
    ...
    delH(10)       = 42.e3_r8
    !
    call addfld( 'SOAM_PROD', 'kg/kg/s', pver, 'A', 'production of SOAM', phys_decomp )
    call addfld( 'SOAI_PROD', 'kg/kg/s', pver, 'A', 'production of SOAI', phys_decomp )
    call addfld( 'SOAT_PROD', 'kg/kg/s', pver, 'A', 'production of SOAT', phys_decomp )
    call addfld( 'SOAB_PROD', 'kg/kg/s', pver, 'A', 'production of SOAB', phys_decomp )
    call addfld( 'SOAX_PROD', 'kg/kg/s', pver, 'A', 'production of SOAX', phys_decomp )
    !
