...
!--------------------------------------------------------------------
         ...
         prod(:,:,1) = 0._r8
         loss(:,:,2) = ( + het_rates(:,:,16))* y(:,:,16)
         prod(:,:,2) = 0._r8
         loss(:,:,3) = ( + het_rates(:,:,17))* y(:,:,17)
         prod(:,:,3) = 0._r8
         loss(:,:,4) = ( + het_rates(:,:,18))* y(:,:,18)
         prod(:,:,4) = 0._r8
         loss(:,:,5) = ( + het_rates(:,:,19))* y(:,:,19)
         prod(:,:,5) = 0._r8
         loss(:,:,6) = ( + het_rates(:,:,20))* y(:,:,20)
         prod(:,:,6) = 0._r8
         loss(:,:,7) = ( + het_rates(:,:,21))* y(:,:,21)
         prod(:,:,7) = 0._r8
         loss(:,:,8) = ( + het_rates(:,:,22))* y(:,:,22)
         prod(:,:,8) = 0._r8
         loss(:,:,9) = ( + het_rates(:,:,23))* y(:,:,23)
         prod(:,:,9) = 0._r8
         loss(:,:,10) = ( + het_rates(:,:,24))* y(:,:,24)
         prod(:,:,10) = 0._r8
         loss(:,:,11) = ( + het_rates(:,:,25))* y(:,:,25)
         prod(:,:,11) = 0._r8
         loss(:,:,12) = ( + het_rates(:,:,26))* y(:,:,26)
         prod(:,:,12) = 0._r8
         loss(:,:,13) = ( + het_rates(:,:,27))* y(:,:,27)
         prod(:,:,13) = 0._r8
         loss(:,:,14) = ( + het_rates(:,:,28))* y(:,:,28)
         prod(:,:,14) = 0._r8
         loss(:,:,15) = ( + het_rates(:,:,29))* y(:,:,29)
         prod(:,:,15) = 0._r8
         loss(:,:,16) = ( + het_rates(:,:,30))* y(:,:,30)
         prod(:,:,16) = 0._r8
         loss(:,:,17) = ( + het_rates(:,:,31))* y(:,:,31)
         prod(:,:,17) = 0._r8
...
!--------------------------------------------------------------------
         ...
         loss(13) = (rxt(7)* y(1) +rxt(9)* y(3) +rxt(11)* y(4) +rxt(14)* y(6) +rxt(16) &
                 * y(8) +rxt(17)* y(9) +rxt(19)* y(11) +rxt(27)* y(12) +rxt(26)* y(14) &
                  + (rxt(24) +rxt(25))* y(15) + rxt(15) + het_rates(2))* y(2)
         ...
         loss(5) = (rxt(11)* y(2) + rxt(2) + het_rates(4))* y(4)
         ...
         loss(3) = ((rxt(24) +rxt(25))* y(2) + het_rates(15))* y(15)
         prod(3) = 0._r8
         loss(4) = (rxt(26)* y(2) + het_rates(14))* y(14)
         prod(4) = (rxt(24)*y(15) +.750_r8*rxt(25)*y(15))*y(2)
         loss(2) = ( + het_rates(13))* y(13)
         prod(2) =rxt(26)*y(14)*y(2)
         loss(6) = (rxt(28)* y(1) +rxt(27)* y(2) + het_rates(12))* y(12)
         prod(6) = 0._r8
