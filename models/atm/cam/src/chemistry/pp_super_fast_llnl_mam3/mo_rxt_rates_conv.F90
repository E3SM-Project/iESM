...
contains
   subroutine set_rates( rxt_rates, sol, ncol )
      ...
      rxt_rates(:ncol,:,    24) = rxt_rates(:ncol,:,    24)*sol(:ncol,:,    15)*sol(:ncol,:,     2)                            ! rate_const*DMS*OH
      rxt_rates(:ncol,:,    25) = rxt_rates(:ncol,:,    25)*sol(:ncol,:,    15)*sol(:ncol,:,     2)                            ! rate_const*DMS*OH
      rxt_rates(:ncol,:,    26) = rxt_rates(:ncol,:,    26)*sol(:ncol,:,    14)*sol(:ncol,:,     2)                            ! rate_const*SO2*OH
      rxt_rates(:ncol,:,    27) = rxt_rates(:ncol,:,    27)*sol(:ncol,:,    12)*sol(:ncol,:,     2)                            ! rate_const*ISOP*OH
      rxt_rates(:ncol,:,    28) = rxt_rates(:ncol,:,    28)*sol(:ncol,:,    12)*sol(:ncol,:,     1)                            ! rate_const*ISOP*O3
