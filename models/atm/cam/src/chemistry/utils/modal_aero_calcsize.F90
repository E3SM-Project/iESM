...
subroutine modal_aero_calcsize_diag(state, pbuf)
   ...
   do n = 1, nmodes
      ...
      ! get mode properties
      call rad_cnst_get_mode_props(0, n, dgnum=dgnum, dgnumhi=dgnumhi, dgnumlo=dgnumlo, &
                                   sigmag=sigmag)

      ! get mode number mixing ratio
      call rad_cnst_get_mode_num(0, n, 'a', state, pbuf, mode_num)
      ...
      do l1 = 1, nspec
         ...
         call rad_cnst_get_aer_mmr(0, n, l1, 'a', state, pbuf, specmmr)
