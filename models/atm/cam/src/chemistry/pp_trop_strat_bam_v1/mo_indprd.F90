...
!--------------------------------------------------------------------
      if( class == 1 ) then
         ...
         prod(:,:,15) = (rxt(:,:,135)*y(:,:,132) +rxt(:,:,144)*y(:,:,54) + &
                 ...
                 rxt(:,:,162)*y(:,:,101) +.500_r8*rxt(:,:,211)*y(:,:,104))*y(:,:,20) &
                  + (rxt(:,:,152)*y(:,:,6) +.900_r8*rxt(:,:,155)*y(:,:,13) + &
                 2.000_r8*rxt(:,:,156)*y(:,:,60) +2.000_r8*rxt(:,:,207)*y(:,:,86) + &
                 rxt(:,:,235)*y(:,:,90))*y(:,:,60) + (rxt(:,:,206)*y(:,:,13) + &
                 2.000_r8*rxt(:,:,208)*y(:,:,86))*y(:,:,86) +rxt(:,:,21)*y(:,:,61) &
                  +.400_r8*rxt(:,:,22)*y(:,:,102)
