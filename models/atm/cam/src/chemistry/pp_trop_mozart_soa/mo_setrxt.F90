...
!-------------------------------------------------------
      ...
      rate(:,:,194) = 1.4e-12_r8 * exp_fac(:,:)
      rate(:,:,197) = 1.4e-12_r8 * exp_fac(:,:)
      rate(:,:,203) = 7.5e-13_r8 * exp_fac(:,:)
      ...
      rate(:,:,193) = 2.3e-12_r8 * exp( -193._r8 * itemp(:,:) )
      exp_fac(:,:) = exp( 350._r8 * itemp(:,:) )
      rate(:,:,195) = 2.6e-12_r8 * exp_fac(:,:)
      rate(:,:,198) = 2.6e-12_r8 * exp_fac(:,:)
      rate(:,:,199) = 1.e-15_r8 * exp( -732._r8 * itemp(:,:) )
      rate(:,:,200) = 1.2e-11_r8 * exp( 444._r8 * itemp(:,:) )
      rate(:,:,201) = 1.2e-12_r8 * exp( 490._r8 * itemp(:,:) )
      rate(:,:,211) = 9.6e-12_r8 * exp( -234._r8 * itemp(:,:) )
      rate(:,:,213) = 1.9e-13_r8 * exp( 520._r8 * itemp(:,:) )
      rate(:,:,214) = 1.7e-12_r8 * exp( -710._r8 * itemp(:,:) )
      rate(:,:,218) = 7.8e-13_r8 * exp( -1050._r8 * itemp(:,:) )
      ...
      call jpl( rate(1,1,217), m, 0.8_r8, ko, kinf, n )
