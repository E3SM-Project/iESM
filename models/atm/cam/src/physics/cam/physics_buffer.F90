...
# 612 "physics_buffer.F90.in"
  ...
  ! TYPE int,double,real 
  ! DIMS 1,2,3,4,5,6
# 646 "physics_buffer.F90.in"
  function get_field_chunk_1d_int(field, c) result(fld) 
# 647 "physics_buffer.F90.in"
